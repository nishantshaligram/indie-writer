            ...
            <div class="wp-block-column is-vertically-aligned-top" style="flex-basis:50%">
                ...
                <div class="wp-block-group" style="margin-bottom:var(--wp--preset--spacing--iw-extra-large)">
                    ...
                    <div class="wp-block-query"><!-- wp:post-template {"layout":{"type":"default","columnCount":3}} -->
                        <!-- wp:group {"tagName":"article","style":{"dimensions":{"minHeight":"25px"}},"layout":{"type":"default"}} -->
                        <article class="wp-block-group" style="min-height:25px">
                            <!-- wp:post-title {"level":3,"isLink":true,"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|iw-small"}}},"fontSize":"iw-m"} /-->

                            <!-- wp:post-excerpt {"showMoreOnNewLine":false,"excerptLength":50,"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|iw-medium"}}},"fontSize":"iw-sm"} /-->
